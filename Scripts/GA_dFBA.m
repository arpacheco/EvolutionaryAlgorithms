function GA_dFBA(saveFileName,dataFile,modelNamesFile,maxNutrients,maxGens,popSize,crossoverProb,mutationProb,maxRandIter,objective,objectiveTarget)
...
%
% GA_dFBA('../Results/GA_dFBA_20NutrientCommunity_MaximizeBSubtilis.mat','../Results/Exhaustive_Community_Parallel_20CS.mat','../Models/modelNamesFacAnaerFormatted.mat',4,100,10,0.8,0.4,50,1,1)
%
% Alan R. Pacheco 04/24/2019, last modified 08/11/2020
...
plot([1:maxGens],mean(maxF(:,:),1),'LineWidth',3,'Color',[135, 179, 141]./255)
...
figure
b = bar(relAbus(unique(finalCombos),:),'stacked','FaceColor','flat');
for k = 1:length(modelNamesForm)
    b(k).CData = k;
end
legend(modelNamesForm)
ylim([0,1])
